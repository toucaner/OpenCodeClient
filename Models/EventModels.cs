...
[JsonDerivedType(typeof(EventTuiToastShow), "tui.toast.show")]
[JsonDerivedType(typeof(EventTuiSessionSelect), "tui.session.select")]
[JsonDerivedType(typeof(EventInstallationUpdated), "installation.updated")]
[JsonDerivedType(typeof(EventInstallationUpdateAvailable), "installation.update-available")]
[JsonDerivedType(typeof(EventProjectUpdated), "project.updated")]
[JsonDerivedType(typeof(EventWorkspaceReady), "workspace.ready")]
[JsonDerivedType(typeof(EventWorkspaceFailed), "workspace.failed")]
[JsonDerivedType(typeof(EventServerInstanceDisposed), "server.instance.disposed")]
[JsonDerivedType(typeof(EventFileEdited), "file.edited")]
[JsonDerivedType(typeof(EventWorktreeReady), "worktree.ready")]
[JsonDerivedType(typeof(EventWorktreeFailed), "worktree.failed")]
[JsonDerivedType(typeof(EventFileWatcherUpdated), "file.watcher.updated")]
[JsonDerivedType(typeof(EventVcsBranchUpdated), "vcs.branch.updated")]
[JsonDerivedType(typeof(EventPermissionAsked), "permission.asked")]
[JsonDerivedType(typeof(EventPermissionReplied), "permission.replied")]
[JsonDerivedType(typeof(EventQuestionAsked), "question.asked")]
[JsonDerivedType(typeof(EventQuestionReplied), "question.replied")]
[JsonDerivedType(typeof(EventQuestionRejected), "question.rejected")]
[JsonDerivedType(typeof(EventLspClientDiagnostics), "lsp.client.diagnostics")]
[JsonDerivedType(typeof(EventLspUpdated), "lsp.updated")]
[JsonDerivedType(typeof(EventSessionStatus), "session.status")]
[JsonDerivedType(typeof(EventSessionIdle), "session.idle")]
[JsonDerivedType(typeof(EventTodoUpdated), "todo.updated")]
[JsonDerivedType(typeof(EventPtyCreated), "pty.created")]
[JsonDerivedType(typeof(EventPtyUpdated), "pty.updated")]
[JsonDerivedType(typeof(EventPtyExited), "pty.exited")]
[JsonDerivedType(typeof(EventPtyDeleted), "pty.deleted")]
[JsonDerivedType(typeof(EventMcpToolsChanged), "mcp.tools.changed")]
[JsonDerivedType(typeof(EventMcpBrowserOpenFailed), "mcp.browser.open.failed")]
[JsonDerivedType(typeof(EventMessageUpdated), "message.updated")]
[JsonDerivedType(typeof(EventMessageRemoved), "message.removed")]
[JsonDerivedType(typeof(EventMessagePartUpdated), "message.part.updated")]
[JsonDerivedType(typeof(EventMessagePartDelta), "message.part.delta")]
[JsonDerivedType(typeof(EventMessagePartRemoved), "message.part.removed")]
[JsonDerivedType(typeof(EventCommandExecuted), "command.executed")]
[JsonDerivedType(typeof(EventSessionCompacted), "session.compacted")]
[JsonDerivedType(typeof(EventSessionCreated), "session.created")]
[JsonDerivedType(typeof(EventSessionUpdated), "session.updated")]
[JsonDerivedType(typeof(EventSessionDeleted), "session.deleted")]
[JsonDerivedType(typeof(EventSessionDiff), "session.diff")]
[JsonDerivedType(typeof(EventSessionError), "session.error")]
